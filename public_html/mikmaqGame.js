...
function displayImage() {
    if (mcq) {
        if (correctPlacement === 0) {
            $("#image1").html('<input class="button" type="image" src='+ images[currCorrect] + ' width="200" height="200" onclick="choose(0)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image2").html('<input class="button" type="image" src='+ images[optionOne] + ' width="200" height="200" onclick="choose(1)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image3").html('<input class="button" type="image" src='+ images[optionTwo] + ' width="200" height="200" onclick="choose(2)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
        } else if (correctPlacement === 1) {
            $("#image1").html('<input class="button" type="image" src='+ images[optionOne] + ' width="200" height="200" onclick="choose(0)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image2").html('<input class="button" type="image" src='+ images[currCorrect] + ' width="200" height="200" onclick="choose(1)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image3").html('<input class="button" type="image" src='+ images[optionTwo] + ' width="200" height="200" onclick="choose(2)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
        } else {
            $("#image1").html('<input class="button" type="image" src='+ images[optionOne] + ' width="200" height="200" onclick="choose(0)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image2").html('<input class="button" type="image" src='+ images[optionTwo] + ' width="200" height="200" onclick="choose(1)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
            $("#image3").html('<input class="button" type="image" src='+ images[currCorrect] + ' width="200" height="200" onclick="choose(2)" wtx-context="3C118555-5166-45EB-9F78-2014808CE8D2">');
        }
    } else {
        if (trueOrFalse) {
            $("#questionImage").html('<input class="button" id="tfImage" type="image" src='+ images[currCorrect] + '>');
        } else {
            $("#questionImage").html('<input class="button" id="tfImage"  type="image" src='+ images[optionOne] + '>');
        }
    }
...
function fillWBank () {
    ...
    for(let i = 0; i < images.length; i++) {
        answers += '<img id="wbank' + i + '"width="100" height="100" src=' + images[i] + '>' + words[i] + '<br></br>'
    }
